...
int main () {
    ...
    float super1, super2;
    int jogo1, jogo2;
    float soma1, soma2, soma3, soma4, resultado1, resultado2;
    ...
    printf("\nEscolha dois atributos para comparacao entre as cartas:");
...
resultado1 = soma1 + soma3;
resultado2 = soma2 + soma4;
    

    printf("\n-------- RESULTADOS DOS ATRIBUTOS SOMADOS --------\n");
    
    printf("\nA soma dos atributos escolhidos para a carta 1 - %s e: %.2f\n",nome1, resultado1);
    printf("\nA soma dos atributos escolhidos para a carta 2 - %s e: %.2f\n",nome2, resultado2);
    
    if (resultado1 > resultado2)
    {
      printf("\nSOMADOS OS ATRIBUTOS A CARTA 1 - %s VENCEU\n"), nome1;
    } else if (resultado1 < resultado2) {
      printf("\nSOMADOS OS ATRIBUTOS A CARTA 2 - %s VENCEU\n"), nome2;
    } else {
      printf("\nAs cartas empataram\n");
    }
